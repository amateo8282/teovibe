...
- [ ] **INFRA-01**: ImportMap에서 vite_ruby로 JavaScript 빌드 파이프라인을 전환하여 JSX/React/npm 패키지를 사용할 수 있다
- [ ] **INFRA-02**: SQLite WAL 모드를 활성화하고 Solid Queue/Cache/Cable이 별도 DB 파일을 사용하도록 구성한다
